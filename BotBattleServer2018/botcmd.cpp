...
void BotCmd::write(ostream &strm)
{
    ...
    case BotCmdType::Resign:
        throw runtime_error("BotCmd::write Resign");
        break;
...
void BotEvent::write(std::ostream& strm, const std::string& typeName, bool includeCollisionAngle, bool includeDistance, bool includeAngleTurned, bool includeScanData)
{
...
{
    strm >> eventTime >> health >> bulletCount;
    if (includeCollisionAngle) {
        strm >> collisionAngle;
    }
    if (includeDistance) {
